...
function updateDashboard(data) {
    ...
    // Update MQ-135 (Air Quality) - from v5 (gas sensor)
    ...
    // Update FC-28 (Water Tank Level) - from v4
    ...
    const tdsValue = data.tds?.value || data.tds || 0;
    console.log('Soil moisture:', tdsValue);
    ...
    // Update quick stats
    document.getElementById('quick-air').textContent = mq135Value < 100 ? 'Good' : mq135Value < 200 ? 'Moderate' : 'Poor';
    ...
    document.getElementById('active-sensors').textContent = '5/5';
}
